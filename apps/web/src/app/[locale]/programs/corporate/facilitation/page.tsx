...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isAr ? 'تيسير الفرق | أكاديمية كُن' : 'Team Facilitation | Kun Academy',
    description: isAr ? 'تيسير احترافي للفرق والمجموعات بمنهجية التفكير الحسّي' : 'Professional team and group facilitation through Somatic Thinking',
  };
}
