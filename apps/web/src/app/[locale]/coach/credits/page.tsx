...
export default function CoachCreditsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <Section variant="white">
      <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-6">{isAr ? 'رصيدي' : 'My Credits'}</h1>
      {loading ? (
