  ...
  return (
    <main>
      ...
      <div className="mx-auto max-w-[var(--max-content-width)] px-4 md:px-6 py-12">
        <div className="h-6 w-48 bg-[var(--color-neutral-100)] rounded mb-8 animate-pulse" />
          ...
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="rounded-2xl border border-[var(--color-neutral-100)] overflow-hidden">
              ...
              <div className="p-5 space-y-3">
                <div className="h-3 w-32 bg-[var(--color-neutral-100)] rounded animate-pulse" />
                <div className="h-5 w-3/4 bg-[var(--color-neutral-100)] rounded animate-pulse" />
                <div className="h-4 w-1/2 bg-[var(--color-neutral-100)] rounded animate-pulse" />
              </div>
            </div>
          ))}
        </div>
