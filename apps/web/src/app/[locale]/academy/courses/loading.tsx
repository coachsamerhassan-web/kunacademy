    ...
    <main>
      <section className="py-16 md:py-24" style={{ background: 'linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-600) 100%)' }}>
        <div className="mx-auto max-w-[var(--max-content-width)] px-4 md:px-6 text-center">
          <div className="h-10 w-52 bg-white/10 rounded-lg mx-auto animate-pulse" />
          <div className="mt-4 h-5 w-72 bg-white/10 rounded mx-auto animate-pulse" />
        </div>
      </section>
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="rounded-2xl border border-[var(--color-neutral-100)] overflow-hidden">
              ...
              <div className="p-5 space-y-3">
                <div className="h-3 w-24 bg-[var(--color-neutral-100)] rounded animate-pulse" />
                ...
                <div className="h-8 w-28 bg-[var(--color-neutral-100)] rounded-lg animate-pulse mt-4" />
              </div>
            </div>
          ))}
        </div>
