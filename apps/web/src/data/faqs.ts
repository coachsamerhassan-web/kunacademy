...
/** Methodology */
export const methodologyFaqs: FAQItem[] = [
  {
...
/** Free programs */
export const freeFaqs: FAQItem[] = [
  {
    ar: { q: 'هل المحتوى المجاني يتطلب تسجيل حساب؟', a: 'بعض المحتوى متاح للجميع مباشرة. الدورات المجانية الكاملة تتطلب إنشاء حساب مجاني للمتابعة وتتبع التقدّم.' },
    en: { q: 'Does free content require an account?', a: 'Some content is available immediately. Full free courses require a free account to track progress.' },
  },
  {
    ar: { q: 'هل يمكنني الحصول على شهادة من البرامج المجانية؟', a: 'البرامج المجانية تمنحك شهادة حضور رقمية. الشهادات المعتمدة من ICF متاحة فقط في البرامج المدفوعة.' },
    en: { q: 'Can I get a certificate from free programs?', a: 'Free programs give you a digital attendance certificate. ICF-accredited certificates are only available in paid programs.' },
  },
];

/** Retreats */
export const retreatsFaqs: FAQItem[] = [
  {
    ar: { q: 'أين تُقام الخلوات؟', a: 'نقيم خلواتنا في مواقع مختارة في الإمارات وتركيا والمغرب. كل خلوة تُصمّم لتوفير بيئة هادئة تدعم التجربة الحسّية.' },
    en: { q: 'Where are retreats held?', a: 'We hold retreats at selected locations in the UAE, Turkey, and Morocco. Each retreat is designed to provide a calm environment that supports the somatic experience.' },
  },
  {
    ar: { q: 'هل الخلوات مناسبة للمبتدئين؟', a: 'بعض الخلوات مفتوحة للجميع وبعضها يتطلب إتمام المستوى 1. التفاصيل موضّحة في صفحة كل خلوة.' },
    en: { q: 'Are retreats suitable for beginners?', a: 'Some retreats are open to all while others require Level 1 completion. Details are specified on each retreat page.' },
  },
];
...
export const shopFaqs: FAQItem[] = [
  {
    ar: { q: 'ما هي المنتجات المتوفّرة في المتجر؟', a: 'نوفّر كتب سامر حسن، بطاقات التفكير الحسّي، أدوات الكوتشينج، وتسجيلات الدورات. جميع المنتجات الرقمية تُسلّم فورًا.' },
    en: { q: 'What products are available in the shop?', a: 'We offer Samer Hassan\'s books, Somatic Thinking cards, coaching tools, and course recordings. All digital products are delivered instantly.' },
  },
  {
    ar: { q: 'هل يتوفّر شحن دولي؟', a: 'المنتجات المادية تُشحن إلى دول الخليج خلال 3-5 أيام عمل. الشحن الدولي متاح لمعظم الدول.' },
    en: { q: 'Is international shipping available?', a: 'Physical products ship to GCC countries within 3-5 business days. International shipping is available to most countries.' },
  },
];
...
export const contactFaqs: FAQItem[] = [
  {
    ar: { q: 'ما هو أسرع طريقة للتواصل؟', a: 'واتساب هو الأسرع للاستفسارات العامة. للاستشارات المؤسسية، أرسل بريدًا إلكترونيًا وسنرد خلال 24 ساعة عمل.' },
    en: { q: 'What is the fastest way to reach you?', a: 'WhatsApp is fastest for general inquiries. For corporate consultations, send an email and we\'ll respond within 24 business hours.' },
  },
  {
    ar: { q: 'هل يمكنني زيارة المقر؟', a: 'نعم، نرحّب بالزيارات بموعد مسبق في مقرنا بمنطقة ميدان الحرة، دبي.' },
    en: { q: 'Can I visit the office?', a: 'Yes, we welcome visits by appointment at our Meydan Free Zone office in Dubai.' },
  },
];
